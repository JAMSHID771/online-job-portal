                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                            <div class="hero-section-text mt-5">
                                ...
                                <!-- Changed href to dynamic route -->
                                <a href="{{ route('job.listings') }}" class="custom-btn custom-border-btn btn">Browse Categories</a>
                            </div>
                        </div>
                    ...
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col-lg-2 col-md-4 col-6">
                            <div class="categories-block">
                                <!-- Changed href to dynamic route -->
                                <a href="{{ route('job.listings') }}" class="d-flex flex-column justify-content-center align-items-center h-100">
                        ...
                        <div class="col-lg-12 col-12">
                                ...
                                <div class="job-body d-flex flex-wrap flex-auto align-items-center ms-4">
                                    <div class="mb-3">
                                        <h4 class="job-title mb-lg-0">
                                            <a href="{{ route('job.details', ['id' => 1]) }}" class="job-title-link">Technical Lead</a>
                                        </h4>
                                    ...
                                    <div class="job-section-btn-wrap">
                                        <a href="{{ route('job.details', ['id' => 1]) }}" class="custom-btn btn">Apply now</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="job-thumb d-flex">
                                ...
                                <div class="job-body d-flex flex-wrap flex-auto align-items-center ms-4">
                                    <div class="mb-3">
                                        <h4 class="job-title mb-lg-0">
                                            <a href="{{ route('job.details', ['id' => 2]) }}" class="job-title-link">Business Director</a>
                                        </h4>
                                    ...
                                    <div class="job-section-btn-wrap">
                                        <a href="{{ route('job.details', ['id' => 2]) }}" class="custom-btn btn">Apply now</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="job-thumb d-flex">
                                ...
                                <div class="job-body d-flex flex-wrap flex-auto align-items-center ms-4">
                                    <div class="mb-3">
                                        <h4 class="job-title mb-lg-0">
                                            <a href="{{ route('job.details', ['id' => 3]) }}" class="job-title-link">HR Manager</a>
                                        </h4>
                                    ...
                                    <div class="job-section-btn-wrap">
                                        <a href="{{ route('job.details', ['id' => 3]) }}" class="custom-btn btn">Apply now</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="job-thumb d-flex">
                                ...
                                <div class="job-body d-flex flex-wrap flex-auto align-items-center ms-4">
                                    <div class="mb-3">
                                        <h4 class="job-title mb-lg-0">
                                            <a href="{{ route('job.details', ['id' => 4]) }}" class="job-title-link">Dev Ops</a>
                                        </h4>
                                    ...
                                    <div class="job-section-btn-wrap">
                                        <a href="{{ route('job.details', ['id' => 4]) }}" class="custom-btn btn">Apply now</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="job-thumb d-flex">
                                ...
                                <div class="job-body d-flex flex-wrap flex-auto align-items-center ms-4">
                                    <div class="mb-3">
                                        <h4 class="job-title mb-lg-0">
                                            <a href="{{ route('job.details', ['id' => 5]) }}" class="job-title-link">UX Designer</a>
                                        </h4>
                                    ...
                                    <div class="job-section-btn-wrap">
                                        <a href="{{ route('job.details', ['id' => 5]) }}" class="custom-btn btn">Apply now</a>
                                    </div>
                                </div>
                            </div>
